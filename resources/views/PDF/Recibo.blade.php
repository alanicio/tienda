...
<div style="width: 100%;height: 18%;margin-left: 15%;"><img src="{{ asset('
	imgs/logo.png') }}" style="width: 100px;float: left"><h3>Confirmación de pedido</h3></div>
...
<footer style="background-color: #1D334C;">
  	<div style="text-align: center;">
  		<a href=" https://www.sistemasnonex.com/"><img src="{{ asset('
  			imgs/footer/internet.png') }}" style="width: 40px;margin-left: 6px;margin-top: 2px;"></a>
  		<a href="http://192.168.2.114:8000/contacto"><img src="{{ asset('
  			imgs/footer/mail.png')}}" style="width: 30px;margin-left: 6px;"></a>
  		<a href="https://www.sistemasnonex.com/blog/"><img src="{{asset('
  			imgs/footer/blog.png')}}" style="margin-left: 6px;margin-top: 2px;"></a>
  		<a href="https://www.facebook.com/sistemas.nonex/"><img src="{{asset('
  			imgs/footer/facebook.png')}}" style="margin-top: 2px;"></a>
  	</div>
